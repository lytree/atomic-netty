package top.lytree.chart.handler.server;
...
import static top.lytree.chart.handler.server.CreateGroupHandler.CREATE_GROUP_HANDLER;
import static top.lytree.chart.handler.server.JoinGroupHandler.JOIN_GROUP_HANDLER;
import static top.lytree.chart.handler.server.ListGroupMembersHandler.LIST_GROUP_MEMBERS_HANDLER;
import static top.lytree.chart.handler.server.MessageHandler.MESSAGE_HANDLER;
import static top.lytree.chart.handler.server.QuitGroupHandler.QUIT_GROUP_HANDLER;
...
public class ServerHandler extends SimpleChannelInboundHandler<Packet> {
    ...
    public ServerHandler() {
        ...
        map.put(Command.SEND_GROUP_MESSAGE_REQUEST, GroupMessageHandler.GROUP_MESSAGE_HANDLER);
    }
