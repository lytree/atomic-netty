...
import static top.lytree.handler.server.CreateGroupHandler.CREATE_GROUP_HANDLER;
import static top.lytree.handler.server.JoinGroupHandler.JOIN_GROUP_HANDLER;
import static top.lytree.handler.server.ListGroupMembersHandler.LIST_GROUP_MEMBERS_HANDLER;
import static top.lytree.handler.server.MessageHandler.MESSAGE_HANDLER;
import static top.lytree.handler.server.QuitGroupHandler.QUIT_GROUP_HANDLER;
